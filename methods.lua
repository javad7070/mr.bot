...
local function code2text(code)
	...
	if code == 101 or code == 105 or code == 107 then
		return _("من مدير نيستم و نميتوانم کسي را اخراج کنم")
	elseif code == 102 or code == 104 then
		return _("من نميتوانم مدير را اخراج يا مسدود کنم")
	elseif code == 103 then
		return _("بدون نياز به مسدوديت! در يک گروه سالم وجود دارد")
	elseif code == 106 then
		return _("اين کاربر عضو گروه نميباشد")
	elseif code == 7 then
		return false
	end
	return false
