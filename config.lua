return {
	bot_api_key = '308616614:AAGpXpVsXYV3aymvFv9nyh_xPQWos3qvzHo',
	cmd = '^[/!#]',
	db = 2, --default redis db: 0
	superadmins = {194144494, 194144494},
	log = {
		chat = 194144494,
		admin = 194144494,
		stats = nil
	...
	channel = '@antispamer', --channel username with the '@'
	source_code = 'https://telegram.me/joinchat/C5Jo7kAwIfWp7EEue5iLQA',
	help_groups = {
		['Internatonal (English)'] = 'https://telegram.me/joinchat/C5Jo7kAwIfWp7EEue5iLQA', --group link, not username!
		['Italian'] = 'https://telegram.me/joinchat/ITAgroupbutler',
		['Persian'] = 'https://telegram.me/joinchat/C5Jo7kAwIfWp7EEue5iLQA',
